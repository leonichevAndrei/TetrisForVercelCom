    ...
    <div class="sub-field-in">
      <div class="top">
        <div :class="['arrow-left', { 'show-left-area': showArea }]">
          ...
          >
            <span v-if="showArea"
              >Tap or hold<br />area to move<br /><span>LEFT</span></span
            >
          </button>
        </div>
        <div :class="['space', { 'show-space-area': showArea }]">
          ...
          >
            <span v-if="showArea">Tap area to<br /><span>ROTATE</span></span>
          </button>
        </div>
        <div :class="['arrow-right', { 'show-right-area': showArea }]">
          ...
          >
            <span v-if="showArea"
              >Tap or hold<br />area to move<br /><span>RIGHT</span></span
            >
          </button>
        </div>
      </div>
      <div :class="['arrow-down', { 'show-down-area': showArea }]">
        ...
        >
          <span v-if="showArea"
            >Tap or hold<br />area to move<br /><span>DOWN</span></span
          >
        </button>
      </div>
    </div>
