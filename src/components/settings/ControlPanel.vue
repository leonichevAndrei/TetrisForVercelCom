...
<template>
  <div class="control-panel">
    ...
    <div
      v-if="appStateEnum[tetrisStore.getAppState] == 'finished'"
      class="line"
    >
      ...
      <div class="elements-block">
        <div class="left">
          <ControlPanelInput
            title="Width"
            :range="conf.width"
            :value="tetrisStore.getWidth"
            :updateStoreFunc="tetrisStore.setWidth"
          />
        </div>
        <div class="center">
          <ControlPanelInput
            title="Height"
            :range="conf.height"
            :value="tetrisStore.getHeight"
            :updateStoreFunc="tetrisStore.setHeight"
          />
        </div>
        <div class="right">
          <ControlPanelInput
            title="Speed"
            :range="conf.speedLevels"
            :value="tetrisStore.getSpeedLevel"
            :updateStoreFunc="tetrisStore.setSpeedLevel"
          />
        </div>
      </div>
    </div>
